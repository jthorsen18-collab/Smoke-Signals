// Waska_PN_A_Rev35_DCOnly_Recalibrated.ino
//
// Rev35 DC Only (recalibrated):
...
void drawOLED(float V, float Idc) {
  ...
  u8g2.drawStr(0, 10, "Waska-PN A Rev35");
...
void setup() {
  initSerial();
  LOGSERIAL.println("BOOT: Waska_PN_A Rev35 DC Only (recalibrated)");
  ...
  LOGSERIAL.print("Rev35: Bat rule forces Gate OFF if V<");
