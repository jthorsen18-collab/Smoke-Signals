// SmokeSignals_Receiver_Lora_Rev.26_Average.ino
//
...
//    SmokeSignals RX Rev 26
//    TC 24.25C
//    A  9.15V  7.10A
//    B  --.--V --.--A
//
// Button (PGM) toggles DASHBOARD <-> AVERAGE
...
void drawDashboard() {
  ...
  u8g2.drawStr(0, 8, "SmokeSignals RX Rev 26");
...
void setup() {
  ...
  delay(200);
  Serial.println();
  Serial.println("SmokeSignals RX Rev26 starting...");
